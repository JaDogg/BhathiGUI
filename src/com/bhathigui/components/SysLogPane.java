...
public class SysLogPane extends javax.swing.JPanel {
    ...
    private Object createListItemObj(String strText,String messageLevel){
        ...
        if(errIco==null) errIco=new ImageIcon(getClass().getResource("/com/bhathigui/res/bad.png"));
        if(imdIco==null) imdIco=new ImageIcon(getClass().getResource("/com/bhathigui/res/bad.png"));
        if(nrmIco==null) nrmIco=new ImageIcon(getClass().getResource("/com/bhathigui/res/bad.png"));
        if(ibdIco==null) ibdIco=new ImageIcon(getClass().getResource("/com/bhathigui/res/bad.png"));
